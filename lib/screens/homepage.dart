...
import 'package:expense_tracker/numorphicCard.dart';
                            ...
                            : ListView.builder(
                              ...
                              physics:BouncingScrollPhysics(),
                                ...
                                itemBuilder: (context, index) {
                                  int reverseIndex =   GoogleSheetsApi.currentTransactions.length - 1 -index;
                                  return Transaction(
                                    transactionName: GoogleSheetsApi  
                                        .currentTransactions[reverseIndex][0],
                                    money: GoogleSheetsApi
                                        .currentTransactions[reverseIndex][1],
                                    expenseOrIncome: GoogleSheetsApi
                                        .currentTransactions[reverseIndex][2],
                                  );
                                }),
                      )
                    ],
